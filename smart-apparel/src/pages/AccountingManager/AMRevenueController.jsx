...
const RevenueController = () => {
  ...
  const updateRevenue = (id) => {
    navigate(`/AM/accounting/updaterevenue/${id}`);
  };
        ...
        <div className="container">
          <div className="card" style={{ backgroundColor: '#d7e3fc' }}>
            ...
            <div className="card-title" style={{ display: "flex", flexDirection: "row", marginLeft: "10px"}}>
              ...
              <button id="backBtnExpense" onClick={() => navigate("/AM/Accounting")}>
                <ArrowBackIcon /> 
              </button>
            ...
            <div className="card-body">
              <div className="divbtn">
                <button id="addBtnExpense">
                  <Link to="/AM/accounting/addrevenue" style={{ color: "inherit", textDecoration: "none" }}>
                    Add New (+)
                  </Link>
                </button>
              </div>
